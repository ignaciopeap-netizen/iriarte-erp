// Iriarte ERP V2 · corrige la tabla financiera para usar el esquema real de movimientos_financieros
(function(){
  'use strict';
  ...
  function fix(){
    clearTimeout(timer);timer=setTimeout(()=>{
      ...
      const h=headings.find(x=>x.textContent.trim()==='Movimientos bancarios');if(!h)return;
