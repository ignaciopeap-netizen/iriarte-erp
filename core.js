...
async function waitForBundles(){
  ...
  catch(e){console.error(e);let err=document.getElementById("lockError");if(err)err.textContent="No se ha podido cargar la aplicación. Recarga la página.";throw e}
}
async function boot(){
